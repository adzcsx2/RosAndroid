...
//        detailName= "/ui/patrol/start";
        ...
        try {
            ...
            root = TreeNode.root();
            genParamTree(root, this.typeDef[0]);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_call:
                ...
                String msg = "";
                if(detailType.equalsIgnoreCase("topic")) {
//                    msg = "{\"op\":\"publish\",\"topic\":\"" + detailName + "\",\"msg:\":["+data+"]"+",\"args\":["+data+"]}";
//                    msg = "{\"op\":\"publish\",\"topic\":\"" + detailName + "\",\"msg:\":[\"data\":"+data+"]}";
    ...
    private void processMoveTopic() {
        ...
        TimerTask timerTask = new TimerTask() {
            ...
            public void run() {
                if (moving) {
                    client.send("{\"op\":\"publish\",\"topic\":\"/cmd_vel\",\"org\":{\"linear\":{\"x\":" + linearX + ",\"y\":0,\"z\":0},\"angular\":{\"x\":0,\"y\":0,\"z\":" + angularZ + "}}}");
