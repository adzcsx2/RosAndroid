...
//            for (String service:nodeDataArray[0]) {
//                if(service.contains("/ui")){
//                    list.add(service);
//                }
//            }
//            nodeDataArray[0] = (String[]) list.toArray(new String[list.size()]);
//            list = new ArrayList<>();
//            for (String service:nodeDataArray[1]) {
//                if(service.contains("/ui")){
//                    list.add(service);
//                }
//            }
//            nodeDataArray[1] = (String[])  list.toArray(new String[list.size()]);
//            list = new ArrayList<>();
//            for (String service:nodeDataArray[2]) {
//                if(service.contains("/ui")){
//                    list.add(service);
//                }
//            }
//            nodeDataArray[2] = (String[])  list.toArray(new String[list.size()]);
